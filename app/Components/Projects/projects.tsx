        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {projectsData.map((project, index) => (
            ...
            >
              ...
              {/* Back Side */}
              <div className="absolute inset-0 bg-white text-gray-800 p-6 flex flex-col justify-between transform rotate-180 group-hover:rotate-0 transition-transform duration-500">
                <div>
                  ...
                  <p className="text-sm">
                    ...
                    <a
                      href={`https://${project.blockchain.toLowerCase()}.etherscan.io/address/${project.contractAddress}`}
                      target="_blank"
                  ...
                  <p className="text-sm">
                    <strong>Rarity:</strong> {project.rarity}
                  </p>
                </div>
